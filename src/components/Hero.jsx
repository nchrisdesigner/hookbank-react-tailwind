  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className="absolute top-0 pink__gradient z-[0] w-[40%] h-[35%]"></div>
        <div className="absolute white__gradient z-[1] w-[80%] h-[80%] rounded-full bottom-40"></div>
        <div className="absolute right-20 bottom-20 blue__gradient z-[0] w-[50%] h-[50%]"></div>
      </div>
